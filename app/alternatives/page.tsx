...
<div>
  ...
  <Navbar2/>
    ...
    <div className="flex flex-col items-center  bg-stone-300 min-h-screen mt-0">
    ...
    <div className="border-2 md:w-7/12 bg-stone-100 bg-opacity-100 shadow-inner-custom mt-7 mb-7">
        
        <div className="font-extrabold text-3xl mb-7 ml-14 mt-24 text-center">
        3 Alternatives to Omegle
        </div>
        <div className="text-black text-left mt-3 ml-14 mr-12 mb-9">
        ...
        <div className="font-bold text-2xl mb-7 ml-14 mt-6 text-black">
        OmeTV
        </div>

        <div className=" text-left mt-3 ml-14 mr-12 mb-9 text-black">
        ...
        <div className=" text-left mt-3 ml-14 mr-12 mb-9 mb-16 text-black">
